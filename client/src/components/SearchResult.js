...
export default function SearchResult(props) {
    ...
    if('image_url' in props.result){
        ...
        style={{background: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(${`https://res-4.cloudinary.com/do6bw42am/image/upload/c_scale,f_auto,h_300/v1/${props.result.image_url}`})`, backgroundSize: 'cover' }}></div>
